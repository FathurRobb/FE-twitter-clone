        ...
        <Container className='w-50 mx-auto d-flex flex-column justify-content-center' style={{minHeight: '90vh'}}>
            ...
            <Form onSubmit={handleSignin}>
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control type="password" name="password" value={password} onChange={handleChangePassword} onBlur={validatePassword} placeholder="Password" required />
                    {error.password && <span className='err' styled={{color: 'red'}}>{error.password}</span>}
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicPassword">
                    <Form.Label>Confirm Password</Form.Label>
                    <Form.Control type="password" name="confirmPassword" value={confirmPassword} onChange={handleChangeConfirmPassword} onBlur={validatePassword} placeholder="Confirm Password" required />
